...
@class OMIDAlgorixcoAdSessionContext;
@class OMIDAlgorixcoAdSessionConfiguration;
...
- (nonnull)initWithContext:(OMIDAlgorixcoAdSessionContext *)context
             configuration:(OMIDAlgorixcoAdSessionConfiguration *)configuration;
