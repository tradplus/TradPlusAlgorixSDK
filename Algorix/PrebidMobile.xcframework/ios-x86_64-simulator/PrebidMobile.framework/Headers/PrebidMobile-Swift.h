...
@property (nonatomic, readonly, copy) NSString * _Nonnull souceAD;
...
+ (void)initializeSDKWithSid:(NSString * _Nonnull)sid token:(NSString * _Nonnull)token appid:(NSString * _Nonnull)appid :(void (^ _Nullable)(enum PrebidInitializationStatus, NSError * _Nullable))completion;
+ (void)initializeSDKWithHost:(NSString * _Nonnull)host sid:(NSString * _Nonnull)sid token:(NSString * _Nonnull)token appid:(NSString * _Nonnull)appid :(void (^ _Nullable)(enum PrebidInitializationStatus, NSError * _Nullable))completion;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
